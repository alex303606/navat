...
import {View, Dimensions, ScrollView, Platform, TouchableOpacity} from 'react-native';
...
export const Slide = (props) => {
    ...
    return (
        <TouchableOpacity activeOpacity={0.3} style={styles.slide} onPress={props.onPress}>
